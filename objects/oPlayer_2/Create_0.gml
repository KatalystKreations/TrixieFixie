...
//Moving
	...
	//crouching
		crouching = false;
		crawling = false;
		head_clear = !place_meeting(x, y-sprite_get_height(sPlayer1Idle), oWall); 
...
#region Sprites
	spr_idle = sPlayer1Idle
	spr_run = sPlayer1Run
	spr_turn = sPlayer1Turn
	spr_jump = sPlayer1Jump
	spr_jump_trans = sPlayer1Jump
	spr_fall = sPlayer1Fall
	spr_crouch = sPlayer1Crouch
	spr_crawl = sPlayer1Crawl
	spr_slide = sPlayer1Slide
	spr_wallslide = sPlayer1WallSlide
...
//spawnpoint
 ...
 rightKey = keyboard_check( ord("L") );
 leftKey = keyboard_check( ord("J") );
 downKey = keyboard_check( ord("K") );
 downKeyPressed = keyboard_check_pressed( ord("K") );
 upKey = keyboard_check( ord("I") );
 jumpKeyPressed = keyboard_check_pressed( ord("I") );
 runKey = keyboard_check(vk_rshift);
